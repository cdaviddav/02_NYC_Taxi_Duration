# -*- coding: utf-8 -*-
"""
Created on Wed Jan 24 20:26:04 2018
...
def main():
    ...
    train = pd.read_csv(r"D:/01_Programmieren/1_Machine_Learning/Python Projects/NYC_Taxi_Duration/01_data/train.csv")
    test = pd.read_csv(r"D:/01_Programmieren/1_Machine_Learning/Python Projects/NYC_Taxi_Duration/01_data/test.csv")
    ...
    preds = model.predict(test)[:, 0]
        ...
        submit_test = pd.read_csv(r"D:/01_Programmieren/1_Machine_Learning/Python Projects/NYC_Taxi_Duration/01_data/test.csv")
    submit_test['trip_duration'] = np.exp(preds) + 1
    submit_test[['id', 'trip_duration']].to_csv(r"D:/01_Programmieren/1_Machine_Learning/Python Projects/NYC_Taxi_Duration/01_data/neural_submission.csv", index=False)
